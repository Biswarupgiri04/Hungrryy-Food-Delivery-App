...
<footer className="bg-white dark:bg-gray-900 border-t border-gray-200">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols-2 gap-20 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                  ...
                  <ul className="text-gray-500 dark:text-gray-400 font-medium">
                      <li className="mb-4">
                          <a href="https://github.com/Biswarupgiri04" target="_blank" className="hover:underline ">Github</a>
                      </li>
                      <li className="mb-4">
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <Link to="/" className="hover:underline">Hungrryy</Link>. All Rights Reserved.
          </span>
          <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
              ...
              <a href="https://github.com/Biswarupgiri04" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                 <GitHubIcon />
              </a>
          </div>
      </div>
