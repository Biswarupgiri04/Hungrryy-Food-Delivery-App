    ...
    return(
        ...
        <div className="mx-auto w-full max-w-screen-xl px-4">
            ...
            <div className=" grid grid-cols-1 lg:grid-cols-4 py-8 gap-8">
                <BenefitCard icon={<WhereToVoteOutlinedIcon sx={{ fontSize: 60 }} color="success"/>} desc="Haldia, West Bengal, India"/>
                <BenefitCard icon={<EmailOutlinedIcon sx={{ fontSize: 60 }} color="success"/>} desc="support@hungrryy.com"/>
                <BenefitCard icon={<LocalPhoneOutlinedIcon sx={{ fontSize: 60 }} color="success"/>} desc="+91 9988776655"/>
